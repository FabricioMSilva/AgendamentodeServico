...
const users = [
  { key: 'ana', email: 'phone-11999990001@ibeleza.local', actualEmail: 'ana@ibeleza.dev', password: 'Demo123!', fullName: 'Ana Souza', phone: '11999990001', role: 'admin' },
  { key: 'marcos', email: 'phone-11999990002@ibeleza.local', actualEmail: 'marcos@ibeleza.dev', password: 'Demo123!', fullName: 'Marcos Lima', phone: '11999990002', role: 'admin' },
  { key: 'juliana', email: 'phone-11999990003@ibeleza.local', actualEmail: 'juliana@ibeleza.dev', password: 'Demo123!', fullName: 'Juliana Reis', phone: '11999990003', role: 'admin' },
  { key: 'vitor', email: 'phone-11977774444@ibeleza.local', actualEmail: 'vitor@ibeleza.dev', password: 'Demo123!', fullName: 'Vitor Almeida', phone: '11977774444', role: 'admin' },
  { key: 'luana', email: 'phone-21966665555@ibeleza.local', actualEmail: 'luana@ibeleza.dev', password: 'Demo123!', fullName: 'Luana Castro', phone: '21966665555', role: 'admin' },
  { key: 'dri', email: 'phone-11988886666@ibeleza.local', actualEmail: 'dri@ibeleza.dev', password: 'Demo123!', fullName: 'Dri Martins', phone: '11988886666', role: 'admin' },
  { key: 'helena', email: 'phone-12433220001@ibeleza.local', actualEmail: 'helena@ibeleza.dev', password: 'Demo123!', fullName: 'Helena Costa', phone: '12433220001', role: 'admin' },
  { key: 'marcia', email: 'phone-12433550002@ibeleza.local', actualEmail: 'marcia@ibeleza.dev', password: 'Demo123!', fullName: 'Marcia Lima', phone: '12433550002', role: 'admin' },
  { key: 'rafaela', email: 'phone-12433220003@ibeleza.local', actualEmail: 'rafaela@ibeleza.dev', password: 'Demo123!', fullName: 'Rafaela Novaes', phone: '12433220003', role: 'admin' },
  { key: 'bruno', email: 'phone-12433550004@ibeleza.local', actualEmail: 'bruno@ibeleza.dev', password: 'Demo123!', fullName: 'Bruno Santos', phone: '12433550004', role: 'admin' },
